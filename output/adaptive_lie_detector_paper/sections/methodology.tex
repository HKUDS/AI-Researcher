...
\end{tikzpicture}
\caption{Architecture of the LLM instructed lie detection pipeline. Solid arrows denote the forward information flow; the dashed feedback arrow indicates the adaptive controller's signal to the interrogator governing whether additional questions are required.}
